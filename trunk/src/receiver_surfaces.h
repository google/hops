...
#ifndef ENERGY_REC_OPTICAL_SIMULATION_RECEIVER_SURFACES_H_
#define ENERGY_REC_OPTICAL_SIMULATION_RECEIVER_SURFACES_H_
...
#endif  // ENERGY_REC_OPTICAL_SIMULATION_RECEIVER_SURFACES_H_
